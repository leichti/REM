...
import re
import types
from REM.chemical import Molecule, Element, only_elements
...
class PhaseConstructor:
    ...
    def check_harvest(self):
        ...
        if (total := abs(sum(self.element_pool.values())-ignored_sum)) >= 10e-16:
...
class ElementalAnalysesParser(Parser):
...
class AnalysesOrganizer(dict):
    ...
    def __init__(self, columns):
        ...
        @todo we need more control of wt.-% and mol-%
        """
